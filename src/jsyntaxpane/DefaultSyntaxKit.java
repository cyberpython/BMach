...
//Modified by Georgios Migdos <cyberpython@gmail.com>
...
public class DefaultSyntaxKit extends DefaultEditorKit implements ViewFactory {
    ...
    public JMenu getJMenu(JEditorPane editorPane) {
    ...
    public void addToolBarActions(JEditorPane editorPane, JToolBar toolbar) {
        addToolBarActions(editorPane, toolbar, -1);
    }

    public void addToolBarActions(JEditorPane editorPane, JToolBar toolbar, int index) {
